...
<html lang="en">
    ...
    <head>
        ...
        <title>Login - Simpedak Dashboard</title>
        <!-- BEGIN: CSS Assets-->
            ...
            <div class="block xl:grid grid-cols-2 gap-4">
                ...
                <div class="hidden xl:flex flex-col min-h-screen">
                    <a href="" class="-intro-x flex items-center pt-5">
                        <img alt="Midone Tailwind HTML Admin Template" class="w-20" src="/assets/images/logo-simpedak.png">
                    </a>
                    <div class="my-auto">
                        ...
                        <div class="-intro-x mt-5 text-lg text-white">Olah kebutuhan bisnis Anda dalam satu tempat</div>
                    </div>
                </div>
                <!-- END: Login Info -->
                <!-- BEGIN: Login Form -->
