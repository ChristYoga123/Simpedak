<section class="py-10 bg-[#3A00E5] sm:pt-16 lg:pt-24">
    <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div class="grid grid-cols-2 gap-x-5 gap-y-12 md:grid-cols-4 md:gap-x-12">
            <div>
                <p class="text-base text-white">Company</p>
            ...
            <div>
                <p class="text-base text-white">Help</p>
            ...
            <div>
                <p class="text-base text-white">Resources</p>
            ...
            <div>
                <p class="text-base text-white">Extra Links</p>
        ...
        <hr class="mt-16 mb-10 border-white" />
        ...
        <div class="flex flex-wrap items-center justify-between">
            ...
            <ul class="flex items-center space-x-3 md:order-3">
                <li>
                    <a href="#" title="" class="flex items-center justify-center text-white transition-all duration-200 bg-transparent border border-white rounded-full w-7 h-7 focus:bg-blue-600 hover:bg-blue-600 hover:border-blue-600 focus:border-blue-600">
