<div class="navbar md:px-10 md:py-4 bg-base-100 fixed w-full z-[999999]">
    <div class="navbar-start">
        ...
        <ul tabindex="0" class="menu menu-sm dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-52">
            <li class="font-semibold"><a class="text-[#3A00E5]">Beranda</a></li>
            <li class="font-semibold"><a class="text-[#3A00E5]">Fitur</a></li>
            <li class="font-semibold"><a class="text-[#3A00E5]">Testimoni</a></li>
            <li class="font-semibold"><a class="text-[#3A00E5]">Kontak</a></li>
        </ul>
        </div>
    ...
    <div class="navbar-center hidden lg:flex">
        <ul class="menu menu-horizontal px-1">
            <li class="font-semibold text-[#3A00E5]"><a>Beranda</a></li>
            <li class="font-semibold text-[#3A00E5]"><a>Fitur</a></li>
            <li class="font-semibold text-[#3A00E5]"><a>Testimoni</a></li>
            <li class="font-semibold text-[#3A00E5]"><a>Kontak</a></li>
        </ul>
    </div>
